...
DEFINE('USER','if0_38819418'); //crea la constante USER con valor 'if0_38819418'
DEFINE('PW','MzTz2Q8uPW');//
DEFINE('HOST','sql303.infinityfree.com');
DEFINE('BD','if0_38819418_empresa');
...
if(!$conexion) 
{
  die("la conexion  con la BD  ha fallado): " + mysqli_error($conexion));
  exit();
}
/*else
{
